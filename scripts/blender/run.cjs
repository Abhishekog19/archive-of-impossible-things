...
if (!['setup', 'version', 'blockout', 'corner', 'world', 'kit'].includes(mode)) throw new Error('Use setup, version, blockout, corner, world or kit')
const scripts = { setup: 'setup.py', blockout: 'hub_blockout.py', corner: 'hub_corner.py', world: 'world_blockout.py', kit: 'asset_kit.py' }
