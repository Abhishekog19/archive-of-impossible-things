...
if (!['setup', 'version', 'blockout', 'corner', 'world', 'kit', 'zones'].includes(mode)) throw new Error('Use setup, version, blockout, corner, world, kit or zones')
const scripts = { setup: 'setup.py', blockout: 'hub_blockout.py', corner: 'hub_corner.py', world: 'world_blockout.py', kit: 'asset_kit.py', zones: 'zone_kit.py' }
